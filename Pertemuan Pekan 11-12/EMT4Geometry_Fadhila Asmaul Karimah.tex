...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-004.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-005.png}
\begin{eulerprompt}
>A=[1,0]; plotPoint(A,"A");
...
>plotSegment(A,C,"b"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-006.png}
\begin{eulerprompt}
>l=angleBisector(A,C,B); // garis bagi <ACB
>g=angleBisector(C,A,B); // garis bagi <CAB
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-007.png}
\begin{eulerprompt}
>plotPoint(P,"P"); // gambar titik potongnya
>r=norm(P-projectToLine(P,lineThrough(A,B))) // jari-jari lingkaran dalam
\end{eulerprompt}
...
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"): // gambar lingkaran dalam
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-008.png}
\begin{eulercomment}
...
>plotSegment(A,C,"b"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-009.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-010.png}
\begin{eulercomment}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-011.png}
\begin{eulerprompt}
>l=angleBisector(A,C,B); // garis bagi <ACB
>g=angleBisector(C,A,B); // garis bagi <CAB
>i=angleBisector(A,B,C); // garis bagi <ABC
...
>plotCircle(circleWithCenter(P,r)):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-012.png}
\begin{eulercomment}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Fadhila Asmaul Karimah-014-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Fadhila Asmaul Karimah-016-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Fadhila Asmaul Karimah-022-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-026.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-028.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-029.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Ini memang sama dengan garis tegak lurus tengah, yang dihitung dengan
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-038.png}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Tentu saja, setiap segitiga siku-siku adalah kasus yang sudah dikenal.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Geometry_Fadhila Asmaul Karimah-042.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry_Fadhila Asmaul Karimah-046-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-047.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
di mana (xm,ym) adalah pusat, dan u dan v adalah separuh sumbu.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Kita melihat bahwa tinggi dan, dengan demikian, luas segitiga maksimal
...
\end{eulerformula}
\begin{eulercomment}
Kita mendapatkan beberapa nilai minimum, yang berkaitan dengan
...
\end{eulerformula}
\begin{eulercomment}
Ada juga metode Lagrange, memaksimalkan H(a,b,c)\textasciicircum{}2 dengan
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Fadhila Asmaul Karimah-054-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-058.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
untuk jari-jari. Kita bisa memeriksa apakah ini benar-benar benar
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-061.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Fadhila Asmaul Karimah-065-large.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Plot lingkaran dan pusatnya. Cu dan U bersifat simbolis. Kita
mengevaluasi ekspresi ini untuk Euler.
\end{eulercomment}
\begin{eulerprompt}
>plotCircle(LL()); plotPoint(O(),"O"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-068.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Tambahkan ke plot yang sudah dibuat.
\end{eulercomment}
\begin{eulerprompt}
>plotPoint(H(),"H"); plotLine(el(),"Garis Euler"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-073.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Fungsi-fungsi mencakup fungsi untuk sudut juga.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Mari kita juga menghitung ungkapan untuk jari-jari lingkaran dalam.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-078.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-080.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Menambahkan solusi pertama ke plot menunjukkan bahwa itulah jalur yang
kita cari. Teori mengatakan bahwa itu adalah parabola yang diputar.
\end{eulercomment}
\begin{eulerprompt}
>plot2d(&rhs(akar[1]),add=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-082.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Fadhila Asmaul Karimah-085-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Fadhila Asmaul Karimah-088-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-089.png}
\begin{eulercomment}
Tentu saja,
...
\end{eulerformula}
\begin{eulercomment}
di mana a dan c adalah kuadrans dari segitiga siku-siku dengan satu
sudut di A.
\end{eulercomment}
\begin{eulerprompt}
>sa &= a/c; $sa
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Fadhila Asmaul Karimah-097-large.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Kita bisa membuat fungsi dari hasil ini. Fungsi tersebut sudah
...
\end{eulerformula}
\begin{eulercomment}
Hasilnya rasional, yang tidak semudah itu jika kita menggunakan
trigonometri klasik.
\end{eulercomment}
\begin{eulerprompt}
>$spread(a,a,4*a/7)
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-102.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Euler juga memiliki fungsi untuk kuadrans antara dua titik.
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Fadhila Asmaul Karimah-105-large.png}
\eulerimg{0}{images/EMT4Geometry_Fadhila Asmaul Karimah-106-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Fadhila Asmaul Karimah-113-large.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Setelah kita memiliki ambang di B, kita dapat menghitung tinggi ha di
sisi a. Ingat bahwa
...
\end{eulerformula}
\begin{eulercomment}
Gambar berikut ini telah dihasilkan dengan program geometri C.a.R.,
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Fadhila Asmaul Karimah-122-large.png}
...
\end{eulerformula}
\begin{eulercomment}
Aturan ini berlaku untuk tiga sudut apa pun yang ditambahkan menjadi
180°.
...
\end{eulerformula}
\begin{eulercomment}
sama, aturan tiga ambang juga benar, jika
...
\end{eulerformula}
\begin{eulercomment}
Karena ambang dari sudut negatif adalah sama, aturan tiga ambang juga
berlaku, jika
...
\end{eulerformula}
\begin{eulercomment}
Sebagai contoh, kita dapat menghitung ambang dari sudut 60°. Itu
...
\end{eulerformula}
\begin{eulercomment}
Ambang dari 90° jelas 1. Jika dua sudut ditambahkan menjadi 90°,
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Fadhila Asmaul Karimah-130-large.png}
\begin{eulercomment}
...
\end{euleroutput}
\eulersubheading{Sudut Bisectors/Pembagi}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-132.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry_Fadhila Asmaul Karimah-134-large.png}
\eulerimg{1}{images/EMT4Geometry_Fadhila Asmaul Karimah-135-large.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Kita bisa mencetak sudut dalam Euler, setelah mentransfer ambangnya ke
radian.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-137.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
berlaku di segitiga manapun. Kuadratkan, ini diterjemahkan ke dalam
...
\end{eulerformula}
\begin{eulercomment}
di mana a, b, c menunjukkan kuadrans.
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-142.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Kita bisa membuatnya menjadi fungsi Euler.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Sebenarnya, spreadnya adalah b/(4r), dan kita lihat bahwa sudut chord
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-148.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-150.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-151.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-153.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-154.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-155.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-156.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-157.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-158.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-159.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Menententukan pusat kedua lingkaran yang jaraknya sama.
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-163.png}
\begin{eulercomment}
\end{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-164.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-165.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-166.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Fadhila Asmaul Karimah-167.png}
